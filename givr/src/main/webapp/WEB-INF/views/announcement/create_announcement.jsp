...
<main class="d-md-flex justify-content-md-center bg-light-gray">
    <section class="login-clean">
        <form class="border-top-univ">
            ...
            <div class="mb-3"><input class="form-control" type="text" id="title" name="title" placeholder="Titre"></div>
            <div class="mb-3"><input class="form-control" type="file" id="files" multiple="" name="images"></div>
            <div class="mb-3"><textarea class="form-control" id="description" placeholder="Description" name="description" style="height: 150px;"></textarea></div>
            <div class="mb-3"><a id="submit-form" class="btn btn-primary w-100 background-univ" href="#">Publier</a></div>
        </form>
    </section>
</main>
</body>
...
<script src="${context}/js/create_donation.js" defer></script>